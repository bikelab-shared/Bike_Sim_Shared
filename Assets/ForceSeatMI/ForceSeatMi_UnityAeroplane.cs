...
namespace MotionSystems
{
	...
	public class ForceSeatMI_UnityAeroplane
	{
		...
		public void Tick(Rigidbody body, float deltaTime, bool paused)
		{
			...
			{
				LowPassFilter(ref m_telemetry.surgeAcceleration, (m_telemetry.surgeSpeed - m_prevSurgeSpeed) / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.swayAcceleration,  (m_telemetry.swaySpeed - m_prevSwaySpeed)   / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.heaveAcceleration, (m_telemetry.heaveSpeed - m_prevHeaveSpeed) / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				...
				LowPassFilter(ref m_telemetry.rollSpeed,  deltaAngles.z / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.pitchSpeed, deltaAngles.x / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.yawSpeed,   deltaAngles.y / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
			}
