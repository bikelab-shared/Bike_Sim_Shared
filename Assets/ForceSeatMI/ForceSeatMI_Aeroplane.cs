...
namespace MotionSystems
{
	class ForceSeatMI_Aeroplane : ForceSeatMI_ITelemetryInterface
	{
		...
		public virtual void Update(float deltaTime, ref FSMI_Telemetry telemetry)
		{
			...
			{
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.surgeAcceleration, (telemetry.surgeSpeed - m_prevSurgeSpeed) / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.swayAcceleration,  (telemetry.swaySpeed - m_prevSwaySpeed)   / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.heaveAcceleration, (telemetry.heaveSpeed - m_prevHeaveSpeed) / deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				...
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.rollSpeed, deltaAngles.z  / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.pitchSpeed, deltaAngles.x / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				ForceSeatMI_Utils.LowPassFilter(ref telemetry.yawSpeed, deltaAngles.y   / deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
			}
